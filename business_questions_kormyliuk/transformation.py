...
print("\n--- План виконання Q1 ---")
q1.explain()
save_result_csv(q1, "results/q1_high_popularity.csv")
...
print("\n--- План виконання Q2 ---")
q2.explain()
save_result_csv(q2, "results/q2_party_songs.csv")
...
print("\n--- План виконання Q3 ---")
q3.explain()
save_result_csv(q3, "results/q3_artist_song_count.csv")
...
print("\n--- План виконання Q4 ---")
q4.explain()
save_result_csv(q4, "results/q4_album_danceability.csv")
...
print("\n--- План виконання Q5 ---")
q5.explain()
save_result_csv(q5, "results/q5_artist_popularity_rank.csv")
...
print("\n--- План виконання Q6 ---")
q6.explain()
save_result_csv(q6, "results/q6_above_avg_popularity.csv")

print("\nУСПІХ! Всі результати збережено у папку results/")